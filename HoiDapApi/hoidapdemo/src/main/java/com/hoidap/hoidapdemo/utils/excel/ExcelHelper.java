package com.hoidap.hoidapdemo.utils.excel;
...
public class ExcelHelper {
    ...
    static String[] HEADERS = { "MÃ£ Lá»›p", "KhÃ³a Há»c", "ChuyÃªn NgÃ nh" };
    ...
    public static ByteArrayInputStream lopsToExcel(List<LopJpaEntity> lops) {
        try (Workbook workbook = new XSSFWorkbook();
            ...
            throw new RuntimeException("Lá»—i khi táº¡o file Excel: " + e.getMessage());
        }
    }
